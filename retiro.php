...
<!DOCTYPE html>
	...
	<body>
        <h1 class="text-center mb-3">Retiro Bancario</h1>
			<form class="w-25 mx-auto">
				...
				Cantidad a Retirar:<input type="number" name="cantidad" id="cantidad" class="form-control">

				<input type="submit" name="retiro" value="Calcular" class="btn btn-dark ms-5 mb-3 mt-3">
				<a type="button" name="index" class="btn btn-dark ms-5 mb-3 mt-3" href="index.php">Regresar</a>
			</form>

			<?php
			    if (isset($_REQUEST["retiro"])) {
